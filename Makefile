...
build: clean
	...
	CGO_ENABLED=0 go build -o client ./cmd/client/...

rpi-build: clean
	CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=6 go build -o server ./cmd/server/...; \
	CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=6 go build -o client ./cmd/client/...
